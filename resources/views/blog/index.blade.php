...
<head>
    ...
    <!-- Owl Carousel -->
    <link rel="stylesheet" type="text/css"
          href="{{ asset('bower_components/owl.carousel/dist/assets/owl.carousel.min.css') }}"/>
    <!-- Youplay -->
...
<section class="content-wrap">
    ...
    <section class="youplay-banner banner-top youplay-banner-parallax">
        <div class="image" style="background-image: url({{ asset('images/banner-bg.jpg') }})">
        </div>
    ...
    <div class="youplay-carousel" data-autoplay="5000">
        <a class="angled-img" href="store-product-1.html">
            <div class="img">
                <img src="{{ asset('images/game-bloodborne-500x375.jpg') }}" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ asset('images/game-dark-souls-ii-500x375.jpg') }}" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ asset('images/game-lords-of-the-fallen-500x375.jpg') }}" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ asset('images/game-middle-eart-shadow-of-mordor-500x375.jpg') }}" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ asset('images/game-soul-sacrifice-500x375.jpg') }}" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ asset('images/game-kingdoms-of-amalur-reckoning-500x375.jpg') }}" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ asset('images/game-the-witcher-500x375.jpg') }}" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ asset('images/game-diablo-iii-500x375.jpg') }}" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
        ...
        <a class="angled-img" href="#!">
            <div class="img">
                <img src="{{ asset('images/game-dragons-dogma-500x375.jpg') }}" alt="">
            </div>
            <div class="over-info">
                <div>
                    <div>
    ...
    <section class="youplay-banner youplay-banner-parallax small">
        <div class="image" style="background-image: url({{ asset('images/banner-witcher-3.jpg') }});">
        </div>

        <div class="info container align-center">
            <div>
                <h2>Día 3:<br> El despertar</h2>
                ...
                <br>
                <br>
                <a class="btn btn-lg" href="#!">Revisar Bitacora</a>
            </div>
        </div>
    </section>
    <!-- /Preorder -->
    ...
    <section class="youplay-news container">
        ...
        <div class="news-one">
            <div class="row vertical-gutter">
                ...
                <div class="col-md-8">
                    ...
                    <div class="tags">
                        <i class="fa fa-tags"></i> <a href="#">Bloodborne</a>, <a href="#">first try</a>, <a href="#">first
                            boss problem</a>, <a href="#">newbie game</a>
                    </div>
                    <div class="description">
                        ...
                        <p>
                            Sum expectantes. Ego hodie expectantes. Expectantes, et misit unum de pueris Gus
                            interficere. Et suus vos. Nescio quis, qui est bonus usus liberi ad Isai? Qui nosti ... Quis
                            dimisit filios ad necem ... hmm? Gus!
                        </p>
                    </div>
        ...
        <div class="news-one">
            <div class="row vertical-gutter">
                ...
                <div class="col-md-8">
                    <div class="clearfix">
                        <h3 class="h2 pull-left m-0"><a href="blog-post-2.html">Coming to Youplay - Dark Souls II</a>
                        </h3>
                        <span class="date pull-right"><i class="fa fa-calendar"></i> March 9, 2015</span>
                    </div>
                    <div class="tags">
                        <i class="fa fa-tags"></i> <a href="#">Dark Souls II</a>, <a href="#">coming soon</a>, <a
                                href="#">first review</a>, <a href="#">sale date</a>
                    </div>
                    <div class="description">
                        Ille vivere. Ut ad te quaerebam ... purgare caeli. Sunt uh ... nonnullus propter errorem qui de
                        rebus inter nos et iacere puto suus in causa, id est in mensa. Levir meus, priusquam oppugnarent
                        tempus quis, admonere dicitur. Credo quod idem mihi praesidium.
                    </div>
            ...
            <div class="row vertical-gutter">
                <div class="col-md-4">
                    <a href="blog-post-3.html" class="angled-img">
                        ...
                        <div class="youplay-hexagon-rating youplay-hexagon-rating-small " data-max="10" data-size="50"
                             title="3.8 out of 10"><span>3.8</span>
                        </div>
                    </a>
                </div>
                <div class="col-md-8">
                    ...
                    <div class="tags">
                        <i class="fa fa-tags"></i> <a href="#">Kingdoms of Amalur</a>, <a href="#">game</a>, <a
                                href="#">review</a>
                    </div>
                    <div class="description">
                        Quod satis pecuniae sempiternum. Ut sciat oportet motum. Nunquam invenies eum. Hic de tabula.
                        Ego vivere, ut debui, et nunc fiant. Istuc quod opus non est. Lorem ipsum occurrebat pragmaticam
                        semper ut, si quis ita velim tibi bene recognoscere. Quorum
                        duo te mihi videtur.
                    </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="owl-carousel" data-autoplay="6000">
                            <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/partner-logo-1.png') }}" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/partner-logo-2.png') }}" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/partner-logo-3.png') }}" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/partner-logo-4.png') }}" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/partner-logo-5.png') }}" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/partner-logo-6.png') }}" alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/partner-logo-7.png') }}"alt="">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/partner-logo-8.png') }}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="youplay-footer-parallax">
        <div class="wrapper" style="background-image: url('assets/images/footer-bg.jpg')">
            ...
            <div class="social">
                <div class="container">
                    <h3>Redes Sociales <strong>BetaCode</strong></h3>
...
<script type="text/javascript"
        src="{{ asset('bower_components/HexagonProgress/jquery.hexagonprogress.min.js') }}"></script>
...
<!-- Countdown -->
<script type="text/javascript"
        src="{{ asset('bower_components/jquery.countdown/dist/jquery.countdown.min.js') }}"></script>
<!-- Youplay -->
